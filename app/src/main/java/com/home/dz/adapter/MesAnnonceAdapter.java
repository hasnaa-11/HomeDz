...
public class MesAnnonceAdapter extends RecyclerView.Adapter<MesAnnonceAdapter.MyViewHolder>{

    private List<Home> homeList;
    private HomeActivity activity;
    private MesAnnonceFragment fragment;

    public MesAnnonceAdapter(List<Home> homeList, HomeActivity activity, MesAnnonceFragment fragment) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            if(id == R.id.anno_delete_item_img){
                fragment.deleteAnnonce(getAdapterPosition());
            }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mesannoncesitem, parent, false);
